...
Launch assets and ready-to-post copy live in `LAUNCH.md`. Distribution targets and follow-up catalog paths live in `SHARE.md`. Teddy-assisted launch operations live in `TEDDY-LAUNCH.md`.
